...
public class CetakStrukLapItemAdapter extends RecyclerView.Adapter {
    Context context;
    List<CetakStrukModel> Datas;
    CetakStrukLapItemActivity cetakStrukLapItemActivity;
    private int view;
    private final int VIEW_TYVE_ITEM = 0, VIEW_TYVE_LOADING = 1;

    public CetakStrukLapItemAdapter(CetakStrukLapItemActivity cetakStrukLapItemActivity, List<CetakStrukModel> cetakStrukModel, int view) {
        this.context = cetakStrukLapItemActivity.getApplicationContext();
        this.cetakStrukLapItemActivity = cetakStrukLapItemActivity;
