...
public class PembayaranOVOActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pembayaran_ovo);
    ...
    private void EventClass() {
        btnLanjut.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                String penjualanMstUid = GlobalTable.savePenjualan(getApplicationContext(), JConst.TIPE_BAYAR_OVO, totalTagihan, totalTagihan,0, "");

                Intent intent = new Intent(PembayaranOVOActivity.this, PembayaranSuccessActivity.class);
                intent.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK | Intent.FLAG_ACTIVITY_CLEAR_TASK | Intent.FLAG_ACTIVITY_SINGLE_TOP);
                intent.putExtra("tipe_bayar", JConst.TIPE_BAYAR_OVO);
